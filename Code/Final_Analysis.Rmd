...
abstract: "This data analysis aims to investigate the effectiveness of the implementation of PM2.5 regulation, which started to be effective in 2003 in California, in the Bay Area. Data from EPA public PM2.5 monitoring were prepared to perform statistical analysis including T-test, ANOVA, and time-series analysis. The project addressed four questions regarding the overall trend of PM2.5 level, comparisons among counties, the point of change in ambient PM2.5 level over time, and the ability of air monitoring data to reflect natural disturbance. Overall, this analysis showed that the regulation was successful based on the data."
fontsize: 12pt
...
```{r explore1, fig.cap="Data Exploration: 9 Bay Area Counties and PM2.5", echo=FALSE,fig.height = 5, fig.width = 8}
...
```{r overallbay, fig.cap = "Mean PM2.5 Across 9 Bay Area Counties", echo=FALSE, fig.height = 4.7, fig.width = 8}
